...
class IceDataset(Dataset):
    ...
    def __len__(self):
        """
        Returns the length of the dataset based on period, predict_period and shift.
        ...
        return int((self.data.shape[1] - self.period + 1) / self.shift)
...
def clip_data_by_batch_and_period(
    ...
    """
    Clips the input data list based on batch size and period.

        Calculates a clipping length based on the provided parameters and returns
        a sliced version of the original data list.

        Args:
            data_list: The list of data to clip.
            batch_size: The desired batch size.
            period: The period for calculation.
            predict_period: The predict period for calculation.
