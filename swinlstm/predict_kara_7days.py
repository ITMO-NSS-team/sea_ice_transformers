...
writer = SummaryWriter(
    f"writer_test/lstm_{in_period}_{predict_period}_predict_7day_52__to52"
)


def setup(args, predict_period, in_period, place):
    """
    Sets up the model, dataloaders, optimizer, and criterion.

        Args:
            args: Parsed arguments for training/prediction.
            predict_period: The period to predict (e.g., number of days).
            in_period: The input period (e.g., number of days).
    ...
    if args.model == "SwinLSTM-D":
        ...
        model.load_state_dict(
            torch.load(
                r"D:\Projects\SwinLSTM\kara_12_6_7days\trained_model_state_dict_mse_43.404335021972656_8_49_13"
            )
        )
...
def main(writer, accumulation_steps, place):
    ...
    Runs the main training and validation loop.
        ...
        Args:
            writer: The writer object for logging data.
