...
class Mlp(nn.Module):
    ...
    def __init__(
        ...
        """
        Initializes a feedforward block.
            ...
            Args:
                ...
                act_layer: The activation layer to use. Defaults to GELU.
...
class Attention(nn.Module):
    ...
    Multi-head self-attention module.
        ...
        This module implements a multi-head attention mechanism, allowing the model to attend
    ...
    def __init__(
        ...
        Initializes the attention layer.
            ...
            Args:
                dim: The input dimension.
                num_heads: The number of attention heads. Defaults to 8.
                qkv_bias: Whether to use bias in the QKV linear transformation. Defaults to False.
                qk_scale: Scaling factor for query and key. If None, defaults to head_dim ** -0.5.
                attn_drop: Dropout probability for attention weights. Defaults to 0..
                proj_drop: Dropout probability for projection layer. Defaults to 0..
                with_qkv: Whether to use QKV linear transformation. Defaults to True.
                mask:  Whether to apply a mask during attention calculation. Defaults to False.
    ...
    def __init__(
        ...
        Initializes a new instance of the class.
            ...
            Args:
                ...
                qk_scale: Scale factor for the query-key interaction.
...
class VisionTransformer(nn.Module):
    ...
    def __init__(
        ...
        Initializes the model.
            ...
            Args:
                ...
                output_size: A list representing the output size (height, width).
                img_size: The input image size (default: 224).
                patch_size: The patch size to divide the image into (default: 16).
                ...
                attention_type: The type of attention mechanism ('divided_space_time', 'space_only', etc.) (default: 'divided_space_time').
                dropout: The dropout rate for the dropout layer (default: 0.).
                out_chans: The number of output channels (default: 1).
                in_periods: The number of input periods (default: 1).
                place: The location/dataset name, used for padding adjustments (default: 'Arctic').
                emb_mult: Multiplier for the embedding dimension (default: 1).
    ...
    def forward_features(self, x):
        """
        Processes input features through the network.
...
class VisionTransformer_3d(nn.Module):
    ...
    def __init__(
        ...
        Initializes the model.
            ...
            Args:
                batch_size (int): The batch size to be used for processing input data.
                ...
                depth (int, optional): The depth of the transformer blocks. Defaults to 12.
                num_heads (int, optional): The number of attention heads. Defaults to 12.
                mlp_ratio (float, optional): The ratio for the MLP layer in the transformer block. Defaults to 4..
                qkv_bias (bool, optional): Whether to use bias in the query, key, and value projections. Defaults to False.
                qk_scale (None, optional):  The scaling factor for the query and key projections. Defaults to None.
                ...
                hybrid_backbone (None, optional): A hybrid backbone network. Defaults to None.
                norm_layer (nn.LayerNorm, optional): The normalization layer to use. Defaults to nn.LayerNorm.
                ...
                place (str, optional): The place for padding selection. Defaults to 'Arctic'.
...
class TimeSformer_3d(nn.Module):
    """
    TimeSformer_3d model for video classification."""
...
class VisionTransformer_conv_augment(nn.Module):
    ...
    def __init__(
        ...
        Initializes the model.
            ...
            Args:
                ...
                output_size: A list representing the output size of the model.
                img_size: The input image size (default: 224).
                patch_size: The patch size to be used for patching the images (default: 16).
                in_chans: The number of input channels (default: 3).
                num_classes: The number of classes for classification (default: 1000).
                embed_dim: The embedding dimension (default: 768).
                depth: The depth of the transformer network (default: 12).
                ...
                qk_scale: Scaling factor for query and key (default: None).
                drop_rate: Dropout rate (default: 0.).
                attn_drop_rate: Attention dropout rate (default: 0.).
                drop_path_rate: Drop path rate (default: 0.1).
                hybrid_backbone: Hybrid backbone network (default: None).
                norm_layer: Normalization layer (default: nn.LayerNorm).
                num_frames: The number of frames in a video sequence (default: 8).
                attention_type: Type of attention mechanism ('divided_space_time', 'space_only', etc.) (default: 'divided_space_time').
                dropout: Dropout rate for the dropout layer (default: 0.).
                out_chans: The number of output channels (default: 1).
                in_periods: Number of input periods (default: 1).
                place: Location string, used to select padding values (default: 'Arctic').
                emb_mult: Multiplier for embedding dimension (default: 1).
    ...
    def reset_classifier(self, num_classes, global_pool=""):
        ...
        Resets the classifier layer of the model.
          ...
          Args:
            num_classes: The new number of classes for classification.
            global_pool: Unused parameter, likely kept for API compatibility.
    ...
    def forward_features(self, x):
        ...
        Processes input features through the model.
          ...
          Returns:
            The processed output tensor after passing through various layers
            including patch embedding, positional encoding, attention blocks, and a final convolution layer.
        """
        B = x.shape[0]
        x, T, W, sizes = self.patch_embed(x)
        cls_tokens = self.cls_token.expand(x.size(0), -1, -1)
